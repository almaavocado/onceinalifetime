...
export function Footer() {
    const socials = [
        {
            name: 'Instagram',
            href: 'https://www.instagram.com/onceinalifetime_15/',
            icon: (props) => (
        ...
        {
            name: 'YouTube',
            href: 'https://www.youtube.com/@onceinalifetime15',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        {
            name: 'TikTok',
            href: 'https://www.tiktok.com/@onceinalifetime_15',
            icon: (props) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        {
            name: 'Yelp',
            href: 'https://www.yelp.com/biz/once-in-a-lifetime-quinceanera-los-angeles?utm_campaign=www_business_share_popup&utm_medium=copy_link&utm_source=(direct)',
            icon: (props) => (
                <img 
